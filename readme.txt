...
* Suppression de la librairie uploadify pour la gestion des envois de documents, la librairie est non recommandée par Wordpress / Delete the uploadify library used for document uplaod management, this library is no recommended by wordpress

= Version 5.1.9.8 =

Correction

* Erreur à la génération du document unique et des fiches de postes/ Error on documents print

= Version 5.1.9.7 =

Améliorations / Improvments

* Renommage de la méthode d'évaluation "Seirich" en "Résultats Seirich"
* Ajout d'une image explicative pour la méthode d'évaluation "Résultats Seirich"
* Modification du modèle de document unique

= Version 5.1.9.6 =

Améliorations / Improvments

* Ajout de l'échelle de notation Seirich dans le logiciel

Correction

* Le modèle du DUER contenait deux fois la description de la méthode du travail en équipe successive alternante en lieu et place du travail répétitif
* Erreur lors de l'enregistrement des catégories de préconisations

= Version 5.1.9.5 =

* T18892 - Erreur à la génération du document unique / Error on document print
...
* T18018 - Affichage commentaires associés à un risque / Displaying comments associated to a risk
* T18531 - Choix de la catégorie de danger
...
* ST481 - Mise &agrave; jour du mod&egrave;le de fiche de poste avec identification de la r&eacute;ponse choisie en face de la cotation
* ST483 - Ajout de la cat&eacute;gorie de pr&eacute;conisation Equipement de protection collective + pr&eacute;conisation divers
* ST485 - Modification visuelle du formulaire d'ajout de notes / commentaire de risque
Corrections

* ST482 - Probl&egrave;me de mise &agrave; jour des unit&eacute;s de travail sur certains caract&egrave;res
* ST484 - Insertion multiple de la variable d'&eacute;valuation de l'amiante

= Version 5.1.8.7 = 

Am&eacute;liorations

* ST477 - Possibilit&eacute; de dupliquer une unit&eacute; de travail (Choix des &eacute;l&eacute;ments &agrave; dupliquer (risques / utilisateurs / pr&eacute;conisations ))
* ST480 - Modification mod&egrave;le fiches de poste

Corrections

* ST478 - Suppression des antislash pr&eacute;sent dans certains documents g&eacute;n&eacute;r&eacute;s (Fiches de poste)
* ST479 - Affichage du commentaire des pr&eacute;conisations dans tous les cas (Ils n'&eacute;taient pas affich&eacute;s si la case image seulement &eacute;tait coch&eacute;e pour l'impression des pr&eacute;conisations)

= Version 5.1.8.6 = 

Am&eacute;liorations

* ST474 - Modification en masse des utilisateurs (* Possibilit&eacute; de modifier les noms/prenoms / * Possibilit&eacute; d'inverser les noms/prenoms / * Suppression du datepicker / possibilit&eacute; d'&eacute;crire au format europ&eacute;en au clavier)
* ST475 - AJout de l'identifiant de l'utilisateur dans le listing natif de wordpress
* ST476 - Format d'affichage des listes d'utilisateurs sur la tableau de bord (plus lisible avec les dates d'embauche/d&eacute;bauche)

= Version 5.1.8.5 =

Am&eacute;liorations

* ST473 - Finalisation de l'integration de la gestion des audits avec le plugins wp-easy-survey (* Association des formulaires aux &eacute;l&eacute;ments de digirisk / * R&eacute;alisation des audits dans les diff&eacute;rents &eacute;l&eacute;ments / * Impression des audits (cl&ocirc;tur&eacute;s ou non))
...
* ST470 - Intégration de la méthode et du danger concernant l'évaluation du danger Amiante
...
* ST465 - Modifications affichage pour le tri des utilisateurs pr&eacute;sents lors de l'&eacute;valuation
* ST466 - Ajout des dates d'affectations des personnes dans le mod&egrave;le des fiches de postes + liste des personnes anciennement affect&eacute;es + liste des personnes pr&eacute;sentes lors de l'&eacute;valuation
* ST467 - Suppression de l'affichage du nombre de risque par &eacute;l&eacute;ment (Provoquait des temps de chargement long sur certaines arborescences)

= Version 5.1.8.1 =

Am&eacute;liorations

* ST463 - Graphisme (- Resserrage des champs dates pour les risques / - Inversion ordre boutons enregistrement risque / - Boite de changement en masse des utilisateurs dans la partie profil)
* ST464 - Ergonomie (- Champs date de la boite de mise &agrave; jour en masse des utilisateurs dans la partie profil / - Ajout d'une option permettant de g&eacute;rer l'affichage ou non des groupes d'utilisateurs et de la gestion des droits dans les diff&eacute;rents &eacute;l&eacute;ments / - R&eacute;organisation champs pointage temps t&acirc;ches et de l'affichage des temps point&eacute;s / - Modification de la gestion des utilisateurs participant &agrave; l'&eacute;valuation)

= Version 5.1.8.0 =

Am&eacute;liorations

* ST461 - Gestion des audits (Utilisation du module wp-easy-survey)

Corrections

* ST462 - Erreur javascripts + Images manquantes

= Version 5.1.7.9 = 

Am&eacute;liorations

* ST460 - Mie en place de boutons sp&eacute;cifiques pour chaque action dans les arbres (Permet d'acc&eacute;der aux fonctionnalit&eacute;s directement)

= Version 5.1.7.7 =

Am&eacute;liorations

* ST455 - Fermeture automatique de la boite de changement en masse des dates utilisateurs + r&eacute;duction de la taille par d&eacute;faut
* ST456 - Affichage des utilisateurs ayant une date de sortie de la soci&eacute;t&eacute; (Affichage des utilisateurs ayant d&eacute;j&agrave; quitt&eacute; la soci&eacute;t&eacute; pour affectation &agrave; de la p&eacute;nibilit&eacute;)
* ST457 - Ajout de racourci pour remplir les dates de d&eacute;but de risque dans la vue d'ensemble

= Version 5.1.7.6 =

Mise &agrave; jour du mod&eacute;le du document unique
...
* ST440 - Affectation des utilisateurs lors d'une recherche (Lorsqu'on cliquait sur l'utilisateur lors d'une recherche dans le champs des box d'affectation l'affectation ne se faisait pas)
...
* ST432 - Impression des fiches de postes dans certaines configurations (Les accents &eacute;taient mal g&eacute;r&eacute;s et emp&ecirc;chaient l'ouverture du fichier g&eacute;n&eacute;r&eacute;)
* ST433 - Le dernier mod&egrave;le utilis&eacute; dans les fiches de postes n'&eacute;taient pas le bon
...
* ST419 - D&eacute;placement des risques sur des photos
* ST420 - Ajout / Modification des commentaires associ&eacute;s &agrave; l'&eacute;valuation d'un risque
...
* ST376 - Int&eacute;gration des correctifs permettant la compatibilit&eacute; entre le plugin et wordpress 3.5
* ST375 - Probl&egrave;me d'affichage des dates des actions correctives
...
* ST339 - Ajout d'une action de correction sur un risque (Ajout d'un nom et d'une description distinctement)
* ST372 - Griser les cases &agrave; cocher d'export des actions correctives si celle ci sont sold&eacute;es
* ST374 - Historisation des commentaires pour l'&eacute;valuation des risques

Corrections

* ST346 - Bugs sur les vecteurs de risques avec une valeur diff&eacute;rente (Les valeurs de chaque variable n'&eacute;taient pas prise en compte)
* ST349 - Champs de recherche autocomplete mal form&eacute; apr&egrave;s le choix (Vidage du champs)
* ST371 - Questions variables des m&eacute;thodes d'&eacute;valuation (- Vibrations ensemble du corps / - Bruit)
* ST373 - Creation d'une solution de r&eacute;cup&eacute;ration des fiches de poste g&eacute;n&eacute;r&eacute;es pour un groupement dans le cas ou le zip serait trop lourd
...
* ST369 - R&eacute;f&eacute;rence non unique pour les documents de type "fiches"
* ST370 - Gestion des droits sur un &eacute;l&eacute;ment donn&eacute; de l'arbre (On avait bien le bouton dans l'arborescence mais pas dans le formulaire)
...
* ST368 - Possibilit&eacute; de g&eacute;n&eacute;rer un listing des risques sur un l&eacute;m&eacute;net au format odt (Fichier contenant: identifiant du risque, photo associ&eacute;e, &eacute;l&eacute;ment associ&eacute;, m&eacute;thode avec d&eacute;tail des variables, cotation, commentaire et action de pr&eacute;vention)

Corrections

* ST367 - Enregistrement des risques dans le mode avanc&eacute; (par photo)
...
* ST365 - Possibilit&eacute; de changer le type d'un groupe d'utilisateur
* ST366 - D&eacute;finition d'une m&eacute;thode par d&eacute;faut permettant de s&eacute;lectionner cette m&eacute;thode lors du clic sur un danger sans p&eacute;nibilit&eacute;

Corrections

* ST364 - Lien mort vers le t&eacute;l&eacute;chargement de open office
...
* ST363 - Cr&eacute;ation du danger "Effondrements, chute d'objet" qui n'&eacute;tait pas cr&eacute;&eacute; dans les nouvelles installations
...
* ST347 - Gestion de l'export des actions correctives dans le DUER

Corrections 

* ST348 - Remise en place de certaines informations manquantes dans le formulaire de gestion des actions correctives 
...
* ST344 - Impression des actions correctives dans le plan d'action du DUER (* Export automatique des actions ajout&eacute;es depuis l'&eacute;valuation des risques / * Possibilit&eacute; de choisir d'exporter le nom et/ou la description depuis la liste des actions correctives)
* ST345 - Int&eacute;grations des pictogrammes concernant les dangers: Risques psychosociaux/circulation interne/rayonnement

Corrections

* ST343 - Erreurs php mineures
...
* ST340 - Mise &agrave; jour des textes

Corrections

* ST341 - Bugs mineurs
* ST342 - Correction d'une faille dans la librairie utilis&eacute;e pour l'envoie des images
